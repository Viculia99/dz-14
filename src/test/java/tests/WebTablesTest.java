...
public class WebTablesTest extends BasicTest{
    private final static String FIRST_NAME = "Victoria";
    private final static String LAST_NAME = "Rymchuk";
    private final static String EMAIL = "vikrim@test.com";
    private final static String AGE = "23";
    private final static String SALARY = "2500";
